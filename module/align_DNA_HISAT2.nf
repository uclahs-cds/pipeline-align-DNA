...
workflow align_DNA_HISAT2_workflow {
   aligner_output_dir = (params.blcds_registered_dataset_output) ? "${params.base_output_dir}/${params.hisat2_version}/BAM-${params.hisat2_uuid}" : "${params.base_output_dir}/${params.hisat2_version}/output"
   aligner_intermediate_dir = (params.blcds_registered_dataset_output) ? "${params.base_output_dir}/${params.hisat2_version}/BAM-${params.hisat2_uuid}/intermediate" : "${params.base_output_dir}/${params.hisat2_version}/intermediate"
   aligner_validation_dir = (params.blcds_registered_dataset_output) ? "${params.base_output_dir}/${params.hisat2_version}/BAM-${params.hisat2_uuid}/validation" : "${params.base_output_dir}/${params.hisat2_version}/validation"
   aligner_log_dir = "${params.log_output_dir}/process-log/${params.hisat2_version}"
   aligner_qc_dir = (params.blcds_registered_dataset_output) ? "${params.base_output_dir}/${params.hisat2_version}/BAM-${params.hisat2_uuid}/QC" : "${params.base_output_dir}/${params.hisat2_version}/QC"
   take:

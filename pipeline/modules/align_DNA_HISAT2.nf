...
workflow align_DNA_HISAT2_workflow {
   ...
   aligner_log_output_dir = "${params.log_output_dir}/align_DNA_HISAT2_workflow"
   take:
      ich_samples
   ...
   main:
      ...
      run_SortSam_Picard(align_DNA_HISAT2.out.bam, aligner_output_dir, aligner_log_output_dir)

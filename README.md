...
| `disable_spark` | yes | boolean | Disable use of Spark processes. When true, `MarkDuplicates` will be used. When false, `MarkDuplicatesSpark` will be used. Default value is false. |
